	      ...
	      <div class="panel-body">
	        ...
	        <form class="form-horizontal" method="post" >
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-md-10">
	              <input type="number" name="telp" required class="form-control" placeholder="Telepon">
	            </div>
	          </div>
	          <div class="form-group">
	            <label for="alamat" class="col-md-2 control-label">Alamat</label>
	            <div class="col-md-10">
	              <textarea name="alamat" required class="form-control" cols="30" rows="2"></textarea>
	            </div>
	          </div>
	          <div class="form-group">
...
<?php
    ...
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan = "INSERT INTO tb_pengguna (id_pengguna,nama_pengguna,username,password,level,tempat,tgl,jk,foto,alamat,telepon,grup) VALUES (
        UUID(),
        '".$_POST['nama_pengguna']."',
        '".$_POST['username']."',
        '".$_POST['password']."',
